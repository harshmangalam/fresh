...
export interface Plugin {
   ...
   * be turned into HTML. The render hook needs to call the `render` function
   * that is passed in as an argument exactly once.
   *
   ...
   */
  render?(render: PluginRenderFunction): PluginRenderResult;
}
